...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [Amount objectAtIndex:indexPath.row];
...
-(void)backClicked:(NSString *)amountText secondParameter:(NSString *)descriptionText{
    [Amount addObject:amountText];
    [Description addObject:descriptionText];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if ([[segue identifier]isEqualToString:@"amountcell"])
    { 
